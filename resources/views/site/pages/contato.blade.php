    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="area-anuncio-total">
                <h1 class="anuncio-titulo"><strong>Dúvidas? Sugestões? Reclamações?<br /> Preencha os campos abaixo.</strong></h1>
                @if (count($errors) > 0)
                ...
                @endif
                <form action="{{route('contato.form')}}"  method="POST"  role="form" class="form-group">
