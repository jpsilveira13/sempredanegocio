                                        ...
                                        <a class="item-total" href="{{url('/')}}/anuncio/{{$advertVeiculo->tipo_anuncio}}/{{$advertVeiculo->id}}/{{str_slug($advertVeiculo->url_anuncio)}}" >
                                            <div class="thumbnail">
                                                @if(count($advertVeiculo->images))
                                                    <?php
                                                    $pos = strpos($advertVeiculo->images()->first()->extension, "imoveis/img");
                                                    $url1 = "";
                                                    if ($pos === false) {
                                                        $url1 = 'gallery/'.$advertVeiculo->images()->first()->extension;
                                                    } else {
                                                ...
                                                <div class="caption infos-suggest">
                                                    <h4 class="group inner list-group-item-heading text-bairro">{{$advertVeiculo->modelo}}<br />
                                                        {{$advertVeiculo->marca}}
                                                    </h4>
