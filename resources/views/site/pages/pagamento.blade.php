                ...
                <ul id="plans">
                    ...
                    <li class="plan col-md-4 col-sm-6 col-xs-12">
                        <ul class="planContainer">
                            ...
                            <li class="button"><a class="btn bestPlanButton disabled" href="#">Adquirir já</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="plan col-md-4 col-sm-6 col-xs-12">
                        <ul class="planContainer">
                            ...
                            <li class="button"><a href="#" class="disabled btn">Adquirir já</a></li>
                        </ul>
                    </li>
                    <li class="plan col-md-4 col-sm-6 col-xs-12">
                        <ul class="planContainer">
                    ...
                    <ul id="plans">
                        <li class="plan col-md-4 col-sm-6 col-xs-12">
                            <ul class="planContainer">
                                ...
                                <li class="button"><a class="btn btnPagamento" href="#" id="{{$bronze->id}}">Anunciar</a></li>
                            </ul>
                        </li>
                        <li class="plan col-md-4 col-sm-6 col-xs-12">
                            <ul class="planContainer">
                        ...
                        <li class="plan col-md-4 col-sm-6 col-xs-12">
                            <ul class="planContainer">
                                ...
                                <li class="button"><a href="#" class="btn disabled">Adquirir já</a></li>
                            </ul>
                        </li>
                        <li class="plan col-md-4 col-sm-6 col-xs-12">
                            <ul class="planContainer">
                                ...
                                <li class="button"><a href="#" class="btn disabled" role="button">Adquirir já</a></li>
                            </ul>
                        </li>
                    </ul> <!-- End ul#plans -->
                </section>
