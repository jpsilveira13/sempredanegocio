...
<div class="row">
    <div class="col-md-12 col-lg-12">
        <div class="area-anuncio-total">
            <h1 class="anuncio-titulo">Postar o seu anúncio é GRÁTIS, rápido e fácil!</h1>
            <p class="anuncio-texto-header">O seu anúncio pode ser visto todos os dias por milhares de pessoas.</p>
            <form action="" method="post" class="form-group" id="budget-form">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6 anuncio-area-localizacao">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-large" placeholder="Nome do bairro ou zona*" name="bairro" />
                        </div>
                        <div class="form-group">
                            <label>Nome da rua: *</label>
                            <input type="text" class="form-control input-large" placeholder="Ex.: Av. Paulista" name="nome-rua" />
                        </div>
                        <div class="form-group">
                            <label>Número da casa/prédio: *</label>
                            <input type="text" class="form-control input-small" placeholder="Ex.: 9999" name="número-casa" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="row">
                            <div class="alert alert-danger">
                                ...
                                <strong>Atenção:</strong> Um anúncio com fotos é visto até 7 vezes mais que um anúncio sem foto.
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
