<!--<aside class="col-md-3 sidebar no-padding-left" id="nav-total">
    ...
    <ul id="menu-fixo" class="bs-docs-sidebar hidden-print hidden-xs hidden-sm" data-spy="affix" data-offset-top="260" data-offset-bottom="200" >
        ...
        <li><a href="#navegacao"><i class="fa fa-car fa-2x"></i> Veículos</a></li>
        <li><a href="#bread"><i class="icon-chevron-right"></i> Breadcrumbs</a></li>
        <li><a href="#paginacao"><i class="icon-chevron-right"></i> Paginação</a></li>
        <li><a href="#alertas"><i class="icon-chevron-right"></i> Alertas</a></li>
