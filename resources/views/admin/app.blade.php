	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav side-nav">
				...
				<li>
					<a href="charts.html"><i class="fa fa-fw fa-user"></i> Minha Conta</a>
				</li>
				<li>
					<a href="tables.html"><i class="fa fa-fw fa-comments"></i> Mensagens</a>
				</li>
				<li>
					<a href="forms.html"><i class="fa fa-fw fa-edit"></i> Meus Anúncios</a>
				</li>
				<li>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="alert alert-info alert-dismissable">
						...
						<i class="fa fa-info-circle"></i>  <strong>João Paulo,</strong> Seja bem vindo
					</div>
				</div>
			</div>
			<!-- /.row -->
